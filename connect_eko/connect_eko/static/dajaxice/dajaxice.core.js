...
var Dajaxice = {
    ...
    recipientregistrationotpverification_ybl: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.recipientregistrationotpverification_ybl', 'POST', callback_function, argv, custom_settings);
    },

    recipientInquiry_ybl: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.recipientInquiry_ybl', 'POST', callback_function, argv, custom_settings);
    },

    recipient_individual_inquiry_ybl: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.recipient_individual_inquiry_ybl', 'POST', callback_function, argv, custom_settings);
    },

    moneytransfer_sbi: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.moneytransfer_sbi', 'POST', callback_function, argv, custom_settings);
    },

    recipientInquiry_icici: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.recipientInquiry_icici', 'POST', callback_function, argv, custom_settings);
    },

    moneytransfer_icici: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.moneytransfer_icici', 'POST', callback_function, argv, custom_settings);
    },

    senderInquiry_ybl: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.senderInquiry_ybl', 'POST', callback_function, argv, custom_settings);
    },

    customerenrolment_icici: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.customerenrolment_icici', 'POST', callback_function, argv, custom_settings);
    },

    recipientregistration_icici: function(callback_function, argv, custom_settings){
        return Dajaxice.call('transaction.recipientregistration_icici', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    sayhello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('agent.sayhello', 'POST', callback_function, argv, custom_settings);
    },

    saybye: function(callback_function, argv, custom_settings){
        return Dajaxice.call('agent.saybye', 'GET', callback_function, argv, custom_settings);
    },

    assign_test: function(callback_function, argv, custom_settings){
        return Dajaxice.call('agent.assign_test', 'POST', callback_function, argv, custom_settings);
    }
